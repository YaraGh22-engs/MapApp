...
namespace GoogleMapApp.Controllers
{
    public class StoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address,longitude,latitude")] Store store)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,longitude,latitude")] Store store)
        {
            if (id != store.Id)
            {
                return NotFound();
